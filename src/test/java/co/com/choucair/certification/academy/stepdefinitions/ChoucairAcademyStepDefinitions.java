...
public class ChoucairAcademyStepDefinitions {
    ...
    @Given("^than Angel wants to learn automation at the academy Choucair$")
    public void thanAngelWantsToLearnAutomationAtTheAcademyChoucair(){
        OnStage.theActorCalled("Angel").wasAbleTo(OpenUp.thePage(), (Login.onThePage()));
